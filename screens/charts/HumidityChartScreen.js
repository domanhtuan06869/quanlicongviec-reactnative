...
export default function DustChartScreen(props) {
  ...
  return (
    <View style={{flex:1,padding:10,}}>
      ...
      <WebView source={{uri:'http://52.221.226.126/chart/hour/humid/1'}}/>
      <Text>This month statistics</Text>
      <WebView source={{uri:'http://52.221.226.126/chart/day/humid/1'}}/>
    </View>
  );
}
...
DustChartScreen.navigationOptions = props=>{
  ...
  header:(
    <View style={styles.header}>
        ...
        <Text style={{fontSize:20,marginTop:5,color:'white',}}>Humidity Chart</Text>
